...
export const IncidentManagementChangeCompleteStatusConfirmDialog = ({ open, onClose, incidentId }) => {
    ...
    <Modal visible={open} onCancel={onClose} footer={null} centered>
      ...
      >
        ...
        >
          ...
          <Typography.Title level={4}>ยืนยันสถานะเสร็จสิ้น</Typography.Title>
          <Typography.Text className="gx-mb-3">กรุณาระบุผลการดำเนินงาน</Typography.Text>
          <Form.Item
            name="status_reason"
            className="gx-w-100"
            rules={[
              {
                required: true,
                message: 'กรุณาระบุผลการดำเนินงาน',
              },
            ]}
          >
