...
const CreateScheduleAgency = () => {
  ...
  const onFinish = (values) => {
    const payload = transformScheduleFormIntoPayload(values);
    setState(
      produce((draft) => {
  ...
  return (
    <>
      ...
      <DutyFormContainer onFinish={onFinish} actionLoading={state.actionLoading} />
    </>
  );
};

export default CreateScheduleAgency;
