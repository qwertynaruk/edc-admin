...
import AbilitySelector from '../../../Component/AbilitySelector';
...
const Officer = () => {
  ...
  const tableDataSource = useTableDataSource(state.users);
      ...
      {/* <Card>
        <SearchMultiverse
          ...
          filter={{
            ...
            dropHeader: 'รายละเอียดผู้ใช้งาน',
          }}
        >
...
export default observer(Officer);
